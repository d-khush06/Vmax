  ...
  return (
    ...
    >
      ...
      {onClose && (
        <button
          onClick={onClose}
          className="absolute -top-4 -right-4 z-50 w-8 h-8 rounded-full bg-[#0a0a0c]/80 backdrop-blur-xl border border-white/10 flex items-center justify-center text-gray-400 hover:text-white hover:bg-white/10 transition-all shadow-[0_0_20px_rgba(0,0,0,0.5)] hover:shadow-[0_0_20px_rgba(255,255,255,0.2)]"
        >
          <X size={15} />
        </button>
      )}
      ...
      {/* Abstract Glow */}
      <div className="absolute -inset-1 bg-gradient-to-r from-orange-500/20 via-rose-500/20 to-purple-500/20 rounded-3xl blur-2xl -z-10 animate-pulse" />

      {/* Main Container */}
      <div className="bg-[#0a0a0c]/80 backdrop-blur-3xl border border-white/10 shadow-[0_30px_100px_-20px_rgba(0,0,0,1)] rounded-3xl p-6 sm:p-8 overflow-hidden relative">
        
        {/* Animated Inner Highlight */}
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-3/4 h-px bg-gradient-to-r from-transparent via-orange-500/50 to-transparent opacity-50" />
        
        {/* Header */}
        <div className="text-center mb-8 relative z-10">
          <div className="mx-auto w-20 h-20 mb-6 rounded-3xl overflow-hidden shadow-[0_0_40px_rgba(249,115,22,0.2)] border border-white/10 relative flex items-center justify-center bg-gradient-to-br from-orange-500/10 to-purple-500/10 backdrop-blur-md group">
            <div className="absolute inset-0 bg-gradient-to-tr from-orange-500 to-purple-600 opacity-20 group-hover:opacity-40 transition-opacity duration-500" />
            <img src="/logo.png" alt="VMAX Logo" className="w-12 h-12 object-cover relative z-10 drop-shadow-[0_0_10px_rgba(255,255,255,0.3)]" />
          </div>
          ...
          <>
            <form onSubmit={mode === 'sign-in' ? handleSignIn : handleSignUp} className="flex flex-col gap-5">
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-11 pr-4 py-3 rounded-xl bg-white/[0.02] border border-white/10 text-white placeholder:text-gray-600 focus:outline-none focus:border-orange-500/50 focus:bg-white/[0.05] focus:ring-4 focus:ring-orange-500/10 transition-all shadow-inner"
                    required
                  />
                </div>
              </div>
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="w-full py-4 rounded-xl bg-gradient-to-r from-orange-500 to-rose-600 text-white font-bold hover:from-orange-400 hover:to-rose-500 transition-all shadow-[0_10px_30px_-10px_rgba(249,115,22,0.5)] hover:shadow-[0_10px_40px_-10px_rgba(249,115,22,0.7)] flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed mt-2 transform hover:-translate-y-0.5 active:translate-y-0"
              >
            ...
            <div className="grid grid-cols-3 gap-3">
              <button
                ...
                className="flex items-center justify-center gap-2 py-3 rounded-xl bg-white/[0.02] border border-white/5 hover:bg-white/10 hover:border-white/20 text-sm font-semibold text-white transition-all hover:-translate-y-0.5"
              >
